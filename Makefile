...
NVCC       := nvcc -g -G -gencode=arch=compute_20,code=\"sm_20,compute_20\" -arch=sm_35
CXX        := g++
CC         := gcc
LINK       := g++ -fPIC
...
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -Iinc -I/ncsu/gcc346/include/c++/3.4.6/backward
